      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col px-6">
        ...
        {isLoading ? (
          ...
          <div className="flex-1 flex flex-col gap-6 mt-6 min-h-0 overflow-hidden">
            ...
            {/* Schedule controls: only meaningful once the entry actually
                generates transactions on a schedule. */}
            {subscription.autoGenerate && subscription.nextDueDate && (
              <div className="flex flex-col gap-2 sm:flex-row">
                <Button
                  variant="outline"
                ...
                >
                  ...
                  {isSkipping ? translate("skipping") : translate("skipNext")}
                </Button>
              </div>
            )}
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {txn.autoGenerated && (
                              <Badge
                                ...
                                title={translate("autoGeneratedTransactionHint")}
                              >
                                {translate("autoGeneratedTransaction")}
                              </Badge>
                            )}
                          </div>
