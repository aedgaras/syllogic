...
function SheetHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("gap-0.5 p-4 flex shrink-0 flex-col", className)}
      {...props}
    />
  )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("sticky bottom-0 gap-2 p-4 mt-auto flex shrink-0 flex-col bg-background", className)}
      {...props}
    />
  )
}
