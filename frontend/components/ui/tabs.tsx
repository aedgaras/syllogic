...
const tabsListVariants = cva(
  "rounded-none p-[3px] group-data-horizontal/tabs:min-h-8 data-[variant=line]:rounded-none group/tabs-list text-muted-foreground inline-flex max-w-full w-fit items-center justify-start overflow-x-auto group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col group-data-[orientation=vertical]/tabs:overflow-visible",
  {
    variants: {
      variant: {
        default: "bg-muted",
