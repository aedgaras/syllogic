      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            <SheetTitle>{translate("sidebar")}</SheetTitle>
            <SheetDescription>
              {translate("displaysTheMobileSidebar")}
            </SheetDescription>
          </SheetHeader>
...
function SidebarTrigger({
  ...
  return (
    ...
    >
      <RiSideBarLine />
      <span className="sr-only">{translate("toggleSidebar")}</span>
    </Button>
  );
}
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "gap-2 p-2 group-data-[collapsible=icon]:px-1 flex flex-col",
        className,
      )}
      {...props}
    />
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn(
        "gap-2 p-2 pb-4 group-data-[collapsible=icon]:px-1 flex flex-col",
        className,
      )}
      {...props}
    />
