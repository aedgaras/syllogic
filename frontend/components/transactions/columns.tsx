...
export const transactionColumns: ColumnDef<TransactionWithRelations>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      // A row the recurring generator booked before the bank reported it —
      // worth flagging, since it is an expectation rather than a fact.
      return row.original.autoGenerated ? (
        <Badge
          variant="outline"
