...
function MappingPageContent() {
  const { isLoading, isSaving, isAiMapping, csvData, mapping, setMapping, continueToPreview, goBack } = useMappingController("onboarding");
    ...
    <div className="space-y-8">
      ...
      <Card className="flex min-h-[640px] flex-col sm:h-[640px]">
        <CardHeader>
          ...
          <CardDescription>
            {translate("matchEachCsvColumnToTheCorrespondingTransactionField3bc30c")}
          </CardDescription>
        </CardHeader>
