...
const row: TransactionListRow = {
  ...
  bookedAt: new Date("2026-01-02T00:00:00Z"),
  pending: false,
  ...
  internalTransfer: {
    ...
    mirrorTxnId: "tx-2",
    sourceAccount: null,
    pocketAccount: { id: "pocket-1", name: "Pocket" },
  },
};
...
describe("transaction list mapper", () => {
  ...
  it("omits orphaned rows and reports them", () => {
    ...
    expect(
      mapTransactionListRows([{ ...row, account: null }], onMissingAccount),
    ).toEqual([]);
